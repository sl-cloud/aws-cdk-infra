...
def test_iam_stack_creation(app, dev_config, mock_vpc_stack, mock_secrets_stack):
    ...
    mock_rds_stack = type('MockRdsStack', (), {
        'secrets_stack': mock_secrets_stack
    })()
    
    mock_sqs_stack = type('MockSqsStack', (), {
        'main_queue': type('MockQueue', (), {'queue_arn': 'arn:aws:sqs:us-east-1:123456789012:test-queue'})(),
        'high_priority_queue': type('MockQueue', (), {'queue_arn': 'arn:aws:sqs:us-east-1:123456789012:test-hp-queue'})(),
        'fifo_queue': type('MockQueue', (), {'queue_arn': 'arn:aws:sqs:us-east-1:123456789012:test-fifo-queue'})(),
        'batch_queue': type('MockQueue', (), {'queue_arn': 'arn:aws:sqs:us-east-1:123456789012:test-batch-queue'})(),
        'dlq': type('MockQueue', (), {'queue_arn': 'arn:aws:sqs:us-east-1:123456789012:test-dlq'})(),
    })()
    
    mock_opensearch_stack = type('MockOpenSearchStack', (), {
        'domain': type('MockDomain', (), {'domain_arn': 'arn:aws:es:us-east-1:123456789012:domain/test-domain'})()
    })()
    
    stack = IamStack(
        app, "TestIamStack", dev_config,
    ...
    template.resource_count_is("AWS::IAM::Role", 2)  # Lambda execution + Application roles
...
def test_ssm_parameters_created(app, dev_config, mock_vpc_stack, mock_secrets_stack):
    ...
    template.resource_count_is("AWS::SSM::Parameter", 9)  # role ARNs + policy ARNs + role names
