...
class OpenSearchStack(Stack):
    ...
    def _create_opensearch_domain(self):
        ...
        self.log_group = logs.LogGroup(
            ...
            retention=logs.RetentionDays.ONE_MONTH if self.config.is_dev else logs.RetentionDays.THREE_MONTHS,
        )
        
        # Add tags to log group
        Tags.of(self.log_group).add("Purpose", Constants.PURPOSE_TAGS["OPENSEARCH_LOGS"])
        for key, value in self.config.tags.items():
            ...
            properties={
                ...
                "AdvancedSecurityOptions": {
                    ...
                    "MasterUserOptions": {
                        ...
                        "MasterUserPassword": self.master_password_secret.secret_value_from_json("password").to_string(),
                    },
                },
